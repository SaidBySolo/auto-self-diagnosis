...
level = {"유치원": "1", "초등학교": "2", "중학교": "3", "고등학교": "4", "특수학교": "5"}
try:
    ...
    driver.find_element_by_xpath(
        '//*[@id="softBoardListLayer"]/div[2]/div[1]/table/tbody/tr[1]/td/select/option[6]'
    ).click()
    driver.find_element_by_xpath(
        '//*[@id="softBoardListLayer"]/div[2]/div[1]/table/tbody/tr[2]/td/select/option[4]'
    ).click()
    driver.find_element_by_xpath(
        '//*[@id="softBoardListLayer"]/div[2]/div[1]/table/tbody/tr[3]/td[1]/input'
    ).send_keys(info["schoolname"])
    driver.find_element_by_xpath(
