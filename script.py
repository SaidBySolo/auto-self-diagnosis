...
try:
    ...
    driver.find_element_by_xpath(
        f'//*[@id="softBoardListLayer"]/div[2]/div[1]/table/tbody/tr[1]/td/select/option[{region}]').click()
    driver.find_element_by_xpath(
        f'//*[@id="softBoardListLayer"]/div[2]/div[1]/table/tbody/tr[2]/td/select/option[{level}]').click()
    driver.find_element_by_xpath(
